    ...
    return (
        <>
            ...
            >
                ...
                <Button sx={{ width: '100%' }} variant="contained" onClick={() => navigate(APP_ROUTES.EMPLOYEES)}>
                    Employees
                </Button>
                <Button sx={{ width: '100%' }} variant="contained" onClick={() => navigate(APP_ROUTES.ADD_EMPLOYEE)}>
                    Add Employee
                </Button>
